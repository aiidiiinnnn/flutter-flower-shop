...
class UserFlowerSearchController extends GetxController {
  ...
  Future<void> getFlowers() async {
    ...
    maxCount.clear();
    isOutOfStock.clear();
    final Either<String, List<UserFlowerSearchViewModel>> flower =
  ...
  Future<void> onTapIncrement(
      {required UserFlowerSearchViewModel flower, required int index}) async {
  ...
  Future<void> addToCart(int index) async {
    ...
    user!.userFlowerList.add(CartFlowerViewModel(
        ...
        vendorName: searchList[index].vendorName,
        vendorLastName: searchList[index].vendorLastName,
        vendorImage: searchList[index].vendorImage,
