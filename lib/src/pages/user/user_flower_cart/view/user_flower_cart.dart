...
class UserFlowerCart extends GetView<UserFlowerCartController> {
  ...
  Obx purchaseButton() {
    return Obx(() => (controller.cartFlowerList.isEmpty)
        ? Padding(
        ...
        : Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: () => {controller.purchaseFlower()},
                  child: Obx(
                    () => (controller.isLoadingPurchase.value)
                        ? const Center(
                            child: SizedBox(
  ...
  Padding totalPrice() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            locale.LocaleKeys.user_total_price.tr,
            style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 20),
          ),
          Obx(
            () => Text("${controller.stringPrice.value}\$",
  ...
  AppBar appBar() {
    return AppBar(
      backgroundColor: const Color(0xfff3f7f7),
      title: Text(
        locale.LocaleKeys.user_shopping_cart.tr,
        style: const TextStyle(
