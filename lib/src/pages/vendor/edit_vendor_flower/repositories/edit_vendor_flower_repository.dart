...
class EditVendorFlowerRepository {
  ...
  Future<Either<String, EditVendorFlowerViewModel>> getFlowerById(
    ...
    if (result.statusCode >= 200 && result.statusCode < 400) {
      return Right(
          EditVendorFlowerViewModel.fromJson(json.decode(result.body)));
    } else {
  ...
  Future<Either<String, CategoriesViewModel>> addCategories(
      CategoriesDto dto) async {
    ...
    if (request.statusCode >= 200 && request.statusCode < 400) {
      return Right(CategoriesViewModel.fromJson(json.decode(request.body)));
    } else {
  ...
  Future<Either<String, ColorsViewModel>> addColors(ColorsDto dto) async {
    ...
    if (request.statusCode >= 200 && request.statusCode < 400) {
      return Right(ColorsViewModel.fromJson(json.decode(request.body)));
    } else {
      return Left('There was an error: ${request.statusCode}');
    }
  }
