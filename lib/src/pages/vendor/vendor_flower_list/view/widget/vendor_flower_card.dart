                        ...
                        Positioned(
                          ...
                          child: InkWell(
                              ...
                              onTap: () {
                                Widget cancelButton = TextButton(
                                    child: Text(
                                        locale.LocaleKeys.vendor_cancel.tr),
                                    onPressed: () {
                                      Navigator.of(context).pop();
                                    });
                                Widget continueButton = TextButton(
                                  child: Text(
                                      locale.LocaleKeys.vendor_continue.tr),
                                  onPressed: () {
                                    controller.deleteFlower(
                                        vendorFlower, index);
                                    Navigator.of(context).pop();
                                ...
                                AlertDialog alert = AlertDialog(
                                  title:
                                      Text(locale.LocaleKeys.vendor_delete.tr),
                                  content: Text(locale
                                      .LocaleKeys
                                      .vendor_are_you_sure_you_want_to_delete_this
                                      .tr),
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (_, index) => Padding(
                                  ...
                                  child: Chip(
                                    label: Center(
                                        child:
                                            Text(vendorFlower.category[index])),
                                  ),
                                )),
                      ),
                    ),
