                ...
                children: [
                  MaterialButton(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.home,color: controller.pageIndex.value==0 ? Colors.blue : Colors.grey),
                        Text("Home",style: TextStyle(
                            color: controller.pageIndex.value==0 ? Colors.blue : Colors.grey
                        ),)
                      ],
                    ),
                  ),
                  MaterialButton(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.person,color: controller.pageIndex.value==1 ? Colors.blue : Colors.grey),
                        Text("Profile",style: TextStyle(
                            color: controller.pageIndex.value==1 ? Colors.blue : Colors.grey
                        ),)
                      ],
                    ),
                  )
