...
import 'package:flower_shop/src/pages/vendor/add_or_edit_vendor_flower/view/widget/number_add_form_field.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_colorpicker/flutter_colorpicker.dart';
import 'package:get/get.dart';
import 'package:taav_ui/taav_ui.dart';
import '../controller/base_vendor_flower_controller.dart';
import '../models/categories/categories_view_model.dart';
import 'widget/custom_add_form_field.dart';

class AddOrEditVendorFlower<T extends BaseVendorFlowerController> extends GetView<T> {
  const AddOrEditVendorFlower({super.key});
                        ...
                        child: TaavTextField.flat(
                          ...
                          onChanged: (final value) {
                            ...
                            Timer(const Duration(milliseconds: 1500), () {
                              if(controller.countController.is_null){
                                controller.countController.text = "1";
                                controller.countNumber.value = int.parse(controller.countController.text);
                              }
                              else{
                                controller.countNumber.value = int.parse(controller.countController.text);
                              }
                          ...
                          label: locale.LocaleKeys.vendor_count.tr,
                          padding: const EdgeInsets.symmetric(vertical: 20.0,horizontal: 15),
                          controller: controller.countController,
                          validator: controller.countValidator,
                          // initialValue: controller.countNumber.value.toString(),
                        ),
                      ),
                    ),
                  ),
                ),
                Obx(() => TaavNumberPicker(
                  onChanged: (final value) {
                    controller.countNumber.value = value;
                    controller.countController.text = value.toString();
                  },
                  // selectedValue: controller.countNumber.value,
                  initialValue: controller.countNumber.value,
                  minValue: 1,
                  maxValue: 1000,
                  decoration: const BoxDecoration(
                    border: Border.fromBorderSide(BorderSide(color: Color(0xff050a0a))),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () {
                              controller.imageFromCamera(context);
                              Navigator.pop(context);
                            },
                          )
                        ],
