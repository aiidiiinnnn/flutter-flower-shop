class AddOrEditVendorFlowerViewModel {
  final int id;
  final String name;
  ...
  AddOrEditVendorFlowerViewModel({
    required this.id,
    required this.name,
  ...
  factory AddOrEditVendorFlowerViewModel.fromJson(Map<String, dynamic> json) {
    return AddOrEditVendorFlowerViewModel(
        id: json["id"],
        name: json["name"],
  ...
  AddOrEditVendorFlowerViewModel copyWith(
          {int? id,
          String? name,
          String? imageAddress,
          String? description,
